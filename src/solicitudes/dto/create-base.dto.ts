import { IsString, IsNumber,IsOptional,Min, IsISO8601, IsArray, ValidateNested } from 'class-validator';
...
export class CreateSolicitudBaseDto {
  ...
  @ValidateNested() @Type(() => UbicacionDto)
  ubicacion: UbicacionDto;

  @IsArray() @ValidateNested({ each: true }) @Type(() => FechaRangoDto)
